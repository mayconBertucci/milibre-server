...
var SendMailController = /** @class */ (function () {
    ...
    SendMailController.prototype.execute = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, to, subject, body, nameTo, nameFrom, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, to = _a.to, subject = _a.subject, body = _a.body, nameTo = _a.nameTo, nameFrom = _a.nameFrom;
                        return [4 /*yield*/, SendMailService_1.default.execute(to, subject, body, nameTo, nameFrom)];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
